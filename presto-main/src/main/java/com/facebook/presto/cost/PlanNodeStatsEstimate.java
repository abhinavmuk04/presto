...
public class PlanNodeStatsEstimate
{
    ...
    public PlanNodeStatsEstimate(
            ...
            @JsonProperty("confident") SourceInfo.ConfidenceLevel confidenceLevel,
    ...
    private PlanNodeStatsEstimate(double outputRowCount, double totalSize, SourceInfo.ConfidenceLevel confidenceLevel, PMap<VariableReferenceExpression, VariableStatsEstimate> variableStatistics)
    {
    ...
    public static final class Builder
    {
        ...
        private Builder(double outputRowCount, double totalSize, SourceInfo.ConfidenceLevel confidenceLevel, PMap<VariableReferenceExpression, VariableStatsEstimate> variableStatistics)
        {
            this.outputRowCount = outputRowCount;
            this.totalSize = totalSize;
        ...
        public Builder setConfidence(SourceInfo.ConfidenceLevel confidenceLevel)
        {
            this.confidenceLevel = confidenceLevel;
            return this;
        }
